...
func main() {
	cases := []caseItem{
		...
		{name: "Bitbank Ethereum", p: yuri.NewBitbankPriceProvider(nil), c: yuri.Currency{Code: "JPY", Decimals: 0}, chain: "eth"},
		{name: "Bitbank", p: yuri.NewBitbankPriceProvider(nil), c: yuri.Currency{Code: "JPY", Decimals: 0}, chain: "btc"},
		{name: "Bitflyer Ethereum", p: yuri.NewBitflyerPriceProvider(nil), c: yuri.Currency{Code: "JPY", Decimals: 0}, chain: "eth"},
		...
		{name: "Buda Ethereum", p: yuri.NewBudaPriceProvider(nil), c: yuri.Currency{Code: "CLP", Decimals: 0}, chain: "eth"},
		...
		{name: "Ripio Ethereum", p: yuri.NewRipioPriceProvider(nil), c: yuri.Currency{Code: "ARS", Decimals: 2}, chain: "eth"},
		{name: "Ripio", p: yuri.NewRipioPriceProvider(nil), c: yuri.Currency{Code: "ARS", Decimals: 2}, chain: "btc"},
		{name: "Yadio Litecoin", p: yuri.NewYadioPriceProvider(nil), c: yuri.USD, chain: "ltc"},
